...
public class WelcomeController {
  ...
  // new
  // CountryDAOImpl(entityManager).findEntityById(birthLocation.getLocationCountryId())
  // .getCountryName());
  // }
  // }
  // } else {
  ...
  // new
  // CountryDAOImpl(entityManager).findEntityById(deathLocation.getLocationCountryId())
  // .getCountryName());
  // }
  // }
  // } else {
  ...
  // }
  //
  // marriagesSpouses = new
  // MarriageDAOImpl(entityManager).getMarriagesBySpouseId(person.getId());
  //
  ...
  // // Look for children
  // children = new
  // PersonDAOImpl(entityManager).findChildrenByParentId(person.getId());
  ...
  // new
  // CountryDAOImpl(entityManager).findEntityById(currentLocation.getLocationCountryId()).getCountryName());
  // }
  // } else {
